...
contract with `yarn build`, test it with `yarn test`, `yarn test-selendra:local` or 
`yarn test-selendra:testnet` and deploy it with `yarn deploy`, `yarn deploy-selendra:local` or
`yarn deploy-selendra:testnet`.